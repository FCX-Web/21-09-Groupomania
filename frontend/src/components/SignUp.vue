...
<div class="px-3 py-2">
    <div>
        <b-form-input v-model="firstName" type="text" class="aside-post input__field" placeholder="Votre prénom" required></b-form-input>
        <b-form-input v-model="lastName" type="text" class="aside-post input__field" placeholder="Votre nom" required></b-form-input>
        ...
        <b-form-input v-model="pwdConfirm" type="password" class="aside-post input__field" placeholder="Confirmez votre mot de passe" required></b-form-input>
    </div>
</div>
</template>
        ...
        if (this.password == this.pwdConfirm) {
            axios
                ...
                .then(response => {
                    ...
                    this.$bvModal.msgBoxOk('Votre compte est créé !!! ... bienvenue ! ', {
                        title: '',
                        size: 'sm',
                        buttonSize: 'sm',
                        okVariant: 'primary',
            ...
            alert("Les deux saisies du mot de passe sont différentes !!!");
        }
    },
}
</script>
